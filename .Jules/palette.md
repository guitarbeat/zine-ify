...
## 2024-05-23 - Decorative Icon Accessibility
**Learning:** Material Symbols ligatures (like `cloud_upload` or `print`) are read aloud by screen readers if not hidden, resulting in confusing announcements like "cloud underscore upload".
**Action:** Always add `aria-hidden="true"` to decorative ligature icons.
