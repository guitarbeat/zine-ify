...
## 2026-03-05 - Material Symbols Ligature Accessibility
**Learning:** Material Symbols ligatures (e.g., `<span class="material-symbols-outlined">cloud_upload</span>`) are announced verbatim by screen readers, creating redundant or confusing auditory feedback.
**Action:** Always add `aria-hidden="true"` to icon ligature elements.
