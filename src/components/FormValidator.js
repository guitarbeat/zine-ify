...
export class FormValidator {
  constructor(formElement, options = {}) {
    ...
    if (!this.form) {
      // console.error('FormValidator: Form element not found'); // eslint-disable-line no-console
      return;
    }
  ...
  register(fieldSelector, config) {
    ...
    if (!field) {
      // console.warn(`FormValidator: Field "${fieldSelector}" not found`); // eslint-disable-line no-console
      return this;
    }
...
export class FieldValidator {
  constructor(field, options = {}) {
    ...
    if (!this.field) {
      // console.error('FieldValidator: Field element not found'); // eslint-disable-line no-console
      return;
    }
